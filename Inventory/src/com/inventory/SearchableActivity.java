...
public class SearchableActivity extends Activity {
	...
	private void handleIntent(Intent intent) {
		if (Intent.ACTION_VIEW.equals(intent.getAction())) {
			...
			// word
			Intent wordIntent = new Intent(this, PlacesActivity.class);
	...
	private void showResults(String query) {
		...
		Cursor cursor = managedQuery(PlacesProvider.CONTENT_URI, null, null,
		...
		if (cursor == null) {
			...
			String[] from = new String[] { PlacesDatabase.KEY_PLACE,
					PlacesDatabase.KEY_COORDINATES };
			...
			mListView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Uri data = Uri.withAppendedPath(PlacesProvider.CONTENT_URI,
							String.valueOf(id));
