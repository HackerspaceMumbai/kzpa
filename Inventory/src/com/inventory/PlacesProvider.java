...
public class PlacesProvider extends ContentProvider {
	String TAG = "PlacesProvider";

	public static String AUTHORITY = "com.inventory.PlacesProvider";
	...
	public static final String DEFINITION_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/vnd.example.android.searchabledict";
	public static final String FUZZY_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/vnd.example.android.searchabledict";

	private PlacesDatabase mDictionary;
	...
	public boolean onCreate() {
		mDictionary = new PlacesDatabase(getContext());
		return true;
	}
	...
	private Cursor getSuggestions(String query) {
		...
		query = query.replaceAll("[aeiou](?!\\b)", "");
		query = query.replaceAll("[-+.^:,'?*()@!$#%]", "");
		query = query.replaceAll("(.)\\1{1,}", "$1");
		query = query.replaceAll("[aeiou]", "");
		
		String[] columns = new String[] { BaseColumns._ID,
				PlacesDatabase.KEY_PLACE, PlacesDatabase.KEY_COORDINATES,
				PlacesDatabase.KEY_FUZZY,
				/*
	...
	private Cursor getWord(Uri uri) {
		...
		String[] columns = new String[] { PlacesDatabase.KEY_PLACE,
				PlacesDatabase.KEY_COORDINATES, PlacesDatabase.KEY_FUZZY };

		return mDictionary.getPlace(rowId, columns);
	}
